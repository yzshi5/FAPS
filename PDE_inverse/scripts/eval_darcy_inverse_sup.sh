...
python "${PDE_ROOT}/pde_eval/PDE_inverse_sup.py" \
  --pde "darcy" \
  ...
  --base-test-data-path "${PDE_ROOT}/datasets/darcy/darcy_pde_test_200.npy" \
  --save-dir "${PDE_ROOT}/outputs/PDE_inverse_sup/darcy" \
  --save-prefix "darcy_reg_super" \
  --device "cuda:0" \
  --seed 22 \
  --test-sample-idx 100 \
  --n-observations 128 \
