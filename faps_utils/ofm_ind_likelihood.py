...
class OFMModel:
    ...
    @torch.no_grad()
    def sample(self, dims, n_channels=1, n_samples=1, n_eval=2, return_path=False, rtol=1e-5, atol=1e-5, method = 'euler'):
    ...
    @torch.no_grad()
    def inv_sample(self, samples, n_eval=2, return_path=False, rtol=1e-5, atol=1e-5, forward=False, method='euler'):
